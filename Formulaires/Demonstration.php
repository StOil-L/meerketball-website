...
<head>
  <meta charset="utf-8" />
  <title>Réinitialisation bdd</title>
</head>
<body> 
...
// -- 'BellePomme' , '7AieH9'
// -- 'BGdelOlympe', 'Rhv2G4'
// -- 'RebelleAntique', 'Z8ijH38'
// -- 'LeMéchant', 'DMva7Fd67'
// -- 'Boss', 'Z8ijH38', 
// -- 'PoissonBleu', '5Cs5pC'
// -- 'LaCouillonne', 'T8Rc9q'
// -- 'Voyageur', 'Q4c3dB'
// -- '1re.JaimeLeVin', 'Vx49pQ'
// -- 'MamanPoule', 'xV2gR6H5t'
...
('BernartJJ', '$2y$10\$p.mijRdGsq2MXmXVrmyXgO1El9Azwuy.uw1oDL3VUUrCBkfiU/IDi', 'fulanito@gmail.com', '2027-11-29', 'JeanJacques', 'BernardJJ', 'Gestionnaire', 'poule.png', 0, NULL);


#Equipe
INSERT INTO Equipe (Categorie, Nom, Niveau, Mail, Telephone, Images) VALUES 
('Poussin', 'los pollos locos', 5,'lucasLePoussin@etu.umontpellier.fr', '0601020304', 'NULL.png'),
('Poussin', 'nomDEQUIPE', 3, 'LePoussin@etu.umontpellier.fr', '0602020304', 'NULL.png'),
('Junior', 'kangoo junior', 2,'vroumVroumFaitLaKangoo@etu.umontpellier.fr', '0601020304', 'NULL.png'),
('Junior', 'Holla jeffe, tou veux oune cérbéssa', 5,'alcoolique@etu.umontpellier.fr', '0603020304', 'NULL.png'),
('Senior', 'les huitres, cest bon!', 4,'mangeurDhuitre@etu.umontpellier.fr', NULL, 'NULL.png'),
('Senior', 'leau ça mouille', 8,'brrr@etu.umontpellier.fr', '0606020304', 'NULL.png'),
('Poussin', 'Tes fou Mon uniforme sort de chez le pressing', 18,NULL, '0604020304', 'NULL.png'),
('Senior', 'les guez', 1,'guez@etu.umontpellier.fr', '0610020304', 'NULL.png'),
('Junior', 'les chipos', 20,'chipos@etu.umontpellier.fr', '0620020304', 'NULL.png'),
('Poussin', 'Amour tout court', 55,'Jetaime@etu.umontpellier.fr', '0631020304', 'NULL.png'),
('Poussin', 'hater', 55,'Jetaime@etu.umontpellier.fr', '0631020304', 'NULL.png'),
('Poussin', 'inscrit pour le fun', 55,'Jetaime@etu.umontpellier.fr', '0631020304', 'NULL.png'),
('Poussin', 'karma', 55,'Jetaime@etu.umontpellier.fr', '0631020304', 'NULL.png'),
('Poussin', 'rate tout', 55,'Jetaime@etu.umontpellier.fr', '0631020304', 'NULL.png'),
('Poussin', 'codeurs', 55,'Jetaime@etu.umontpellier.fr', '0631020304', 'NULL.png'),
('Poussin', 'francs', 55,'Jetaime@etu.umontpellier.fr', '0631020304', 'NULL.png'),
('Poussin', 'celtes', 55,'Jetaime@etu.umontpellier.fr', '0631020304', 'NULL.png'),
('Poussin', 'vikings', 55,'Jetaime@etu.umontpellier.fr', '0631020304', 'NULL.png'),
('Poussin', 'on est 18e', 55,'Jetaime@etu.umontpellier.fr', '0631020304', 'NULL.png'),
('Poussin', 'on est 19e', 55,'Jetaime@etu.umontpellier.fr', '0631020304', 'NULL.png'),
('Poussin', 'on est 20e', 55,'Jetaime@etu.umontpellier.fr', '0631020304', 'NULL.png');
...
(11, 'Arbre à licornes', 'Phase inscription', '2022-03-01', 70, 'Montpellier', 12, 'Coupe', 'tour_du_lez.png', 'FeminineSenior'),
(3, 'Basket et Prunes','Phase inscription', '2025-12-25', 6, 'Thionville', 4, 'Championnat', 'ba-et-pru.png', 'Poussin'),
(3, 'Elementaire mon cher','Phase inscription', '2023-04-01', 55, 'Londres-Paris', 8, 'PlusieursTours', 'elembasket.png', 'Senior'),
...
(6, 'Du basket juste','Acheve', '2021-01-29', 75, 'Salle polyvalente de St-Jean de Cuculles', 4, 'Coupe', 'sexism.png', 'Senior'),
(6, 'Basket-folie-2009', 'Phase inscription','2022-02-22', 100, 'France', 6, 'Poule', 'folier2009.png', 'Junior'),
(6, 'placeholder', 'Phase inscription','2023-02-16', 90, NULL, 8, 'Championnat', 'default.png', 'Benjamin'),
...
(8, 'test championnat', 'Acheve', '2018-03-17', 35, 'Pays des Licornes', 8, 'Championnat', 'licorne.png', 'Poussin'),
...
(8, 'Premier Touraaaaaa', 'En cours', '2021-02-21', 180, 'Chez moi', 8, 'Coupe', 'default.png', 'Handicap'),
(11, 'Championnat des Super-Licornes', 'Phase inscription', '2021-05-01', 12, 'Chez Cedric', 20, 'Championnat', 'default.png', 'Poussin');
...
(1,16,0,'2021-06-16 00:00:00'),
(2,16,0,'2021-06-16 00:00:00'),
(3,16,0,'2021-06-16 00:00:00'),
(4,16,0,'2021-06-16 00:00:00'),
(5,16,0,'2021-06-16 00:00:00'),
(6,16,0,'2021-06-16 00:00:00'),
(7,16,0,'2021-06-16 00:00:00'),
(8,16,0,'2021-06-16 00:00:00'),
(9,16,0,'2021-06-16 00:00:00'),
(10,16,0,'2021-06-16 00:00:00'),
(11,16,0,'2021-06-16 00:00:00'),
(12,16,0,'2021-06-16 00:00:00'),
(13,16,0,'2021-06-16 00:00:00'),
(14,16,0,'2021-06-16 00:00:00'),
(15,16,0,'2021-06-16 00:00:00'),
(16,16,0,'2021-06-16 00:00:00'),
(17,16,0,'2021-06-16 00:00:00'),
(18,16,0,'2021-06-16 00:00:00'),
(19,16,0,'2021-06-16 00:00:00'),
(20,16,1,'2021-06-16 00:00:00'),
(21,16,1,'2021-06-16 00:00:00');
...
(5, 9, '2021-04-01 12:00:00', 'Lyon', 55, 0, 'En attente', 5, 7, 12, 10, 'Lyon.png'),
...
for($i=0;$i<20/2*(2*20-2);$i+=1){
    $dbh->exec("INSERT INTO Rencontre(Tournoi) VALUES(16)");
    $sql="SELECT IdRencontre FROM Rencontre WHERE IdRencontre>=(SELECT max(IdRencontre) FROM Rencontre) AND Tournoi=16";
    foreach($dbh->query($sql) as $row){
$dbh->exec("INSERT INTO Championnat(Tournoi,Rencontre) VALUES( 16,$row[IdRencontre])");
}
}
